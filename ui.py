...
def display_analysis_results(analysis_result):
    ...
    st.markdown(
        '<div style="text-align: right; font-size: 0.8rem; color: #888; margin-bottom: 10px;">Powered by MJ Recruitment</div>',
        unsafe_allow_html=True
    )
    ...
    with col2:
        report_content = f"""
# MJ Recruitment - Resume Analysis Report
...
"""
        ...
        report_content += "\n---\nAnalysis provided by MJ Recruitment Agent"
    ...
    if st.button("Generate Interview Questions"):
        if generate_questions_func:
            with st.spinner("Generating personalized interview questions..."):
                ...
                download_content = f"# MJ Recruitment - Interview Questions\n\n"
    ...
    if st.button("Generate Resume Improvements"):
        if improve_resume_func:
            with st.spinner("Analyzing and generating improvements..."):
                ...
                # Create content for download
                download_content = f"# MJ Recruitment - Resume Improvement Suggestions\n\nTarget Role: {target_role if target_role else 'Not specified'}\n\n"
                ...
                # Add Euron branding to download content
                download_content += "\n---\nProvided by MJ Recruitment Agent"
...
---
Resume enhanced by MJ Recruitment Agent
"""
